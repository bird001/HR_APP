...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $emppass = $_POST['EmpPass1']; //md5() to encrypt 
    ...
    if ($emppassSet == 1 && $empphoneSet == 1 && $empmailSet == 1 && $lnameSet == 1 && $empposSet == 1 && $fnameSet == 1 && $empdobSet == 1 && $empstartSet == 1) {

        //insert into Users table-------------------------------------------------------------------------

        $registration = "insert into HR_DEPT.Users(FirstName,LastName,EmpSex,EmpID,EmpEmail,EmpStatus,EmpDept,EmpRole,EmpPosition,EmpAddress,EmpDOB,EmpPhone,EmpStartDate,EmpPass,TimeCreated)
      values(
      '$fname','$lname','$empsex','$empnum','$empmail','$status','$empdept','$role','$emppos','$empadd','$newDateDOB','$empphone','$newDateStart','$emppass',NOW()
      )";
...
<html>
    ...
    <body bgcolor="#FFFFFF">
        ...
        <div align="center" class = "form-group">
            <h1>Register</h1>
            <div style="width:500px; border: solid 1px #333333; " class = "form-group" align="left">
                ...
                <div style="margin:30px">
                    ...
                    <form action="#" method="post" id="form1" class = "form-group" role="form" >
                        ...
                        <div class="form-group">
                            ...
                            <span class="error"><?php echo $emppassError; ?></span>
                        </div>
