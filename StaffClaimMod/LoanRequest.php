            ...
            <tbody>
                ...
                foreach ($rows as $row) {
                    ...
                    if ($dept == 'Accounts' && empty($row['VerifiedBy']) || (($dept == 'Accounts' && !empty($row['ApprovedBy'])) && ($dept == 'Accounts' && !empty($row['VettedBy'])))) {
                        ...
                        '<td align = "center"><input type="checkbox" name = "checked_id[]" class = "checkbox" id = "tablecheck" value= "' . $row['id_val'] . '" >' . '</td>' .
                    ...
                    //this if statement shows and hides relevant data from the GM
